...
const NavMenu: React.FC = () => {
    // TODO: 실제 라우팅 구현
    const menuItems = [
        { icon: <Search size={16} className="text-gray-500" />, name: "검색" },
    ...
    return (
        <div className="px-2">
            {menuItems.map((item, index) => (
                <a key={index} href="#" className="flex items-center p-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100">
